// import styles from '/css/jigsaw.css'
...
class Jigsaw {
    ...
    draw (img) {
        ...
        drawPath(this.canvasCtx, this.x, this.y, 'fill')  //填充区域，原大图中间填充颜色
        drawPath(this.blockCtx, this.x, this.y, 'clip')  //剪切区域，只有剪切区域是可见的，裁剪小图

        // 画入图片
        this.canvasCtx.drawImage(img, 0, 0, width, height)   //canvas填充图片
        this.blockCtx.drawImage(img, 0, 0, width, height)   //canvas填充图片,只显示剪切区域
